...
# Load the image
orig_imga = cv2.imread("placac1.png")
...
cv2.imwrite("new_imagec1.png", new_image2)
if DEBUG==0:
    cv2.imwrite('edgesc1.png', edges)
    cv2.imwrite('processedc2.png', processed)
    cv2.imwrite('rejectedc.png', rejected)
    
orig_imga = cv2.imread("placac2.png")
orig_img = cv2.resize(orig_imga, (0,0), fx=3, fy=3, interpolation=cv2.INTER_CUBIC)
# Add a border to the image for processing sake
img = cv2.copyMakeBorder(orig_img, 50, 50, 50, 50, cv2.BORDER_CONSTANT)
...
# blur a bit to improve ocr accuracy
new_image2 = cv2.blur(new_image, (2,2 ))
cv2.imwrite("new_imagec2.png", new_image2)
if DEBUG==0:
    cv2.imwrite('edgesc2.png', edges)
    cv2.imwrite('processedc2.png', processed)
    cv2.imwrite('rejectedc2.png', rejected)